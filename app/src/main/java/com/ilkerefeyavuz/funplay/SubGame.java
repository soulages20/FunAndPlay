...
public class SubGame {
    ...
    public SubGame(){
        ...
        totalQuestions = 0;
        score = 0;
        currentQuestion = new SubQuestion(10);
        questions = new ArrayList<SubQuestion>();
    }
    public void makeNewQuestion(){
        currentQuestion = new SubQuestion(20);
        totalQuestions++;
    ...
    public SubQuestion getCurrentQuestion() {
        return currentQuestion;
    }

    public void setCurrentQuestion(SubQuestion currentQuestion) {
